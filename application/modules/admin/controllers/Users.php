...
class Users extends Admin_Controller{
    ...
    public function __construct()
  {
      ...
      $this->add_script( 'https://editor.datatables.net/extensions/Editor/js/dataTables.editor.min.js',true,'foot');
      ...
      $this->add_script('https://cdn.datatables.net/buttons/1.4.1/js/buttons.flash.min.js',true,'foot');
      ...
      //$this->add_script('https://cdn.datatables.net/buttons/1.2.1/js/buttons.print.min.js',true,'head');
      ...
      $this->add_script('https://cdn.datatables.net/buttons/1.4.1/js/buttons.print.min.js',true,'foot');
