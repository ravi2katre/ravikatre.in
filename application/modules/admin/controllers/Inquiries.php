...
class Inquiries extends Admin_Controller
{
    ...
    public $model_name = 'Inquiry_model';
    public function __construct()
    {
        ...
        $this->mViewData['columns'] = array('', "{$this->table}.id", "{$this->table}.product_id", "{$this->table}.farmer_id", "{$this->table}.name", "{$this->table}.details", "{$this->table}.delevery_date",' u.phone');
        $this->mViewData['display_columns'] = array('', 'id', 'product_name', 'farmer_name', 'name', 'details', 'delevery_date', 'phone');
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $item) {
            ...
            foreach ($this->mViewData['display_columns'] as $val) {
                if (!empty($val)) {
                    $row[] = $item->$val;
                }
            }
