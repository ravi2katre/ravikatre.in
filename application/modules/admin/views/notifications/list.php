        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Msg Type</label>
                            <div class="col-md-9">
                                <select name="detail[msg_type]" class="form-control">
                                    <option value="">--Select--</option>
                                    <?php
                                    $list = array('SMS' => 'SMS', 'EMAIL' => 'EMAIL', 'PUSH' => 'PUSH');
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select name="detail[group_name]" class="form-control">
                                    <option value="">--Select--</option>
                                    <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="detail[subject]" placeholder="Subject" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea name="detail[msg]" placeholder="Message" class="form-control"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <button type="button" id="btnSave" onclick="save()" class="btn btn-primary">Send & Save</button>
